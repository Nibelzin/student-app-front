...
import {
  BookOpen, Calendar, CheckCircle2, ChevronDown, ChevronUp,
  ClipboardList, ExternalLink, FileIcon, GraduationCap, Loader2, Plus, UserX,
} from 'lucide-react'
...
import type { Activity, Material } from '@/types/types'
  ...
  return (
    <Card className="shadow-none rounded-sm">
      <CardContent className="py-3 px-4 flex items-center justify-between">
        ...
        <span className={`text-xs font-medium px-2 py-0.5 rounded-full shrink-0 ml-3 ${statusClass}`}>
          {statusLabel}
        </span>
      </CardContent>
    </Card>
        ...
        {isAssessmentsLoading ? (
          ...
          <div className="space-y-2">
            {assessments?.content
              ...
              .map(assessment => (
                <Card key={assessment.id} className="shadow-none rounded-sm">
                  <CardContent className="py-3 px-4 flex items-center justify-between">
                    <div>
